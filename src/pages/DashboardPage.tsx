  ...
  return (
    <div className="flex flex-col rounded-2xl border border-slate-100 bg-white p-5 shadow-sm">
      <div className="flex items-center gap-3 mb-4">
        <div className="animate-pulse h-9 w-9 rounded-xl bg-slate-100 shrink-0" />
        <div className="animate-pulse h-4 w-32 rounded bg-slate-200" />
      </div>
      <div className="flex items-center justify-between">
        <div className="animate-pulse h-3 w-20 rounded bg-slate-100" />
        <div className="animate-pulse h-3 w-14 rounded bg-slate-100" />
      </div>
    </div>
  )
}
  ...
  return (
    <div className="px-8 py-8 max-w-4xl">
      <div className="mb-8">
        {isLoading ? (
          <>
            <div className="animate-pulse h-7 w-48 rounded-lg bg-slate-200 mb-2" />
            <div className="animate-pulse h-4 w-24 rounded bg-slate-100" />
          </>
        ) : (
          <>
      ...
      {isLoading ? (
        <div className="space-y-8">
          <section>
            <div className="animate-pulse h-3 w-24 rounded bg-slate-200 mb-3" />
