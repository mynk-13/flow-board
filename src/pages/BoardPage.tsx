...
export function BoardPage() {
  ...
  return (
    <div className="flex h-full flex-col">
      {/* Top bar */}
      <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-700/60 bg-white dark:bg-slate-900 px-5 py-3">
        <Link to="/" className="text-slate-400 dark:text-slate-500 hover:text-slate-700 dark:hover:text-slate-200">
          <ArrowLeft size={16} />
        </Link>
        ...
        <div className="flex items-center gap-2 ml-1">
          {socketConnected ? (
            ...
            <span title="Reconnecting…" className="flex items-center gap-1 text-[11px] text-slate-400 dark:text-slate-500 font-medium">
        ...
        <div className="ml-auto flex items-center gap-2">
          ...
          {isAdmin && project ? (
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-300 hover:bg-indigo-50 dark:hover:bg-indigo-950/40 hover:border-indigo-300 dark:hover:border-indigo-700 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
            >
            ...
            <button
              ...
              className="flex items-center gap-1.5 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 px-3 py-1.5 text-xs font-medium text-slate-600 dark:text-slate-300 hover:bg-slate-50 dark:hover:bg-slate-700 transition-colors"
            >
          ...
          <div className="relative">
            ...
            <input
              ...
              className="rounded-xl border border-slate-200 dark:border-slate-700 bg-slate-50 dark:bg-slate-800 py-1.5 pl-7 pr-3 text-xs text-slate-700 dark:text-slate-300 placeholder-slate-400 dark:placeholder-slate-500 focus:border-indigo-400 dark:focus:border-indigo-600 focus:outline-none focus:bg-white dark:focus:bg-slate-800 transition-colors"
            />
          </div>
      ...
      {/* Reader notice */}
      {myRole === 'reader' && (
        <div className="flex items-center gap-2 border-b border-amber-100 dark:border-amber-900/40 bg-amber-50 dark:bg-amber-950/30 px-5 py-2 text-xs text-amber-700 dark:text-amber-400">
          <Eye size={12} />
