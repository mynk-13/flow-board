...
export function TeamChart({ tasks, projects, userId }: Props) {
  // Build a map of uid → display name (email first char + uid prefix)
  ...
  if (data.length === 0) {
    return <EmptyState message="No tasks with assignees yet" />
  }
